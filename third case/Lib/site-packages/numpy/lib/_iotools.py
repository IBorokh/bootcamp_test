...
def has_nested_fields(ndtype):
    ...
    >>> np.__lib._iotools.has_nested_fields(dt)
    False
...
def flatten_dtype(ndtype, flatten_base=False):
    ...
    >>> dt = np.dtype([('name', 'S4'), ('x', float), ('y', float),
    ...                ('block', int, (2, 3))])
    >>> np.__lib._iotools.flatten_dtype(dt)
    [dtype('S4'), dtype('float64'), dtype('float64'), dtype('int64')]
    >>> np.__lib._iotools.flatten_dtype(dt, flatten_base=True)
    [dtype('S4'),
     dtype('float64'),
     dtype('float64'),
     dtype('int64'),
...
class NameValidator:
    ...
    Examples
    --------
    >>> validator = np.__lib._iotools.NameValidator()
    >>> validator(['file', 'field2', 'with space', 'CaSe'])
    ('file_', 'field2', 'with_space', 'CaSe')

    >>> validator = np.__lib._iotools.NameValidator(excludelist=['excl'],
    ...                                           deletechars='q',
...
def str2bool(value):
    ...
    Examples
    --------
    >>> np.__lib._iotools.str2bool('TRUE')
    True
    >>> np.__lib._iotools.str2bool('false')
    False
...
def easy_dtype(ndtype, names=None, defaultfmt="f%i", **validationargs):
    ...
    Examples
    --------
    >>> np.__lib._iotools.easy_dtype(float)
    dtype('float64')
    >>> np.__lib._iotools.easy_dtype("i4, f8")
    dtype([('f0', '<i4'), ('f1', '<f8')])
    >>> np.__lib._iotools.easy_dtype("i4, f8", defaultfmt="field_%03i")
    dtype([('field_000', '<i4'), ('field_001', '<f8')])

    >>> np.__lib._iotools.easy_dtype((int, float, float), names="a,b,c")
    dtype([('a', '<i8'), ('b', '<f8'), ('c', '<f8')])
    >>> np.__lib._iotools.easy_dtype(float, names="a,b,c")
