...
class _FileOpeners:
    ...
    --------
    >>> import gzip
    >>> np.__lib._datasource._file_openers.keys()
    [None, '.bz2', '.gz', '.xz', '.lzma']
    >>> np.__lib._datasource._file_openers['.gz'] is gzip.open
    True
...
class Repository (DataSource):
    ...
    (note: this is not self-contained code)::
        ...
        >>> repos = np.__lib._datasource.Repository('/home/user/data/dir/')
    ...
    Similarly you could use a URL for a repository::
        ...
        >>> repos = np.__lib._datasource.Repository('http://www.xyz.edu/data')
